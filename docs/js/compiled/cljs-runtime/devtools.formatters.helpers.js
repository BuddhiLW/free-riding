...
var G__28689 = devtools.prefs.pref(v);
v = G__28689;
continue;
} else {
return v;
...
}catch (e28622){var _e__27790__auto__ = e28622;
return false;
}})();
...
}catch (e28625){var _e__27790__auto__ = e28625;
return false;
}})();
...
}catch (e28628){var _e__27790__auto__ = e28628;
return false;
}}
}
});
...
var vec__28653 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28653,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28653,(1),null);
...
return cljs.core.some((function (p1__28666_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28666_SHARP_);
}),template);
});
