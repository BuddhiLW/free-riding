...
var G__28711 = devtools.prefs.pref(v);
v = G__28711;
continue;
} else {
return v;
...
}catch (e28685){var _e__27845__auto__ = e28685;
return false;
}})();
...
}catch (e28687){var _e__27845__auto__ = e28687;
return false;
}})();
...
}catch (e28689){var _e__27845__auto__ = e28689;
return false;
}}
}
});
...
var vec__28697 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28697,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28697,(1),null);
...
return cljs.core.some((function (p1__28701_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28701_SHARP_);
}),template);
});
