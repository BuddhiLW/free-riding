...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_44649 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_44649(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_44655 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_44655(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_44680 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_44680(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_44682 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_44682(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_44686 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_44686(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_44695 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_44695(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__44628,callback){
var map__44631 = p__44628;
var map__44631__$1 = cljs.core.__destructure_map(map__44631);
var input = map__44631__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44631__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44631__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
