...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40752 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40752(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40753 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40753(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40758 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40758(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40759 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40759(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40764 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40764(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40765 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40765(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40766 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40766(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40767 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40767(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40768 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40768(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40769 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40769(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40770 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40770(b);
}
});
