...
var o28256 = temp__5802__auto__;
var temp__5802__auto____$1 = (o28256["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o28257 = temp__5802__auto____$1;
return (o28257["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27792__auto__ = f;
return (o__27792__auto__["toString"]).call(o__27792__auto__);
} else {
return "";
}
...
try{var o__27792__auto___28668 = t;
(o__27792__auto___28668["cljs$lang$ctorPrWriter"]).call(o__27792__auto___28668,t,writer);
}catch (e28280){var __28669 = e28280;
}
...
var char_code = (function (){var o__27792__auto__ = (new String(char$));
return (o__27792__auto__["charCodeAt"]).call(o__27792__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27792__auto__ = String;
return (o__27792__auto__["fromCharCode"]).call(o__27792__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28312 = num_code;
switch (G__28312) {
case (1):
return (185);
...
var o__27792__auto__ = String;
return (o__27792__auto__["fromCharCode"]).call(o__27792__auto__,superscript_code);
});
/**
...
}catch (e28347){var _e__27845__auto__ = e28347;
return false;
}})())){
...
var vec__28350 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28350,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28395){
var vec__28396 = p__28395;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28396,(0),null);
...
var G__28674 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28675 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28674;
remaining_tokens = G__28675;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28390){
...
var vec__28449 = cljs.core.split_with((function (p1__28444_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28444_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28449,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28449,(1),null);
...
var vec__28462 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28462,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28677 = cljs.core.rest(remaining_tokens);
var G__28678 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28677;
name_tokens = G__28678;
continue;
} else {
...
var vec__28479 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28479,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28479,(1),null);
var vec__28482 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28482,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28482,(1),null);
var vec__28485 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28485,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28485,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28485,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28485,(3),null);
...
var vec__28504 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28504,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28504,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28504,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28504,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28504,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28504,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__28513 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28513,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28513,(1),null);
var vec__28516 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28516,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28516,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28536 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28536) : devtools.munging.parse_fn_info_deep.call(null,G__28536));
})()));
}
} else {
return fn_info;
...
var G__28691 = (arity + (1));
var G__28692 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28565){
var vec__28566 = p__28565;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28566,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28566,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28578_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28578_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28580_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28580_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28586){
var vec__28587 = p__28586;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28587,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28582){
var G__28583 = cljs.core.first(seq28582);
var seq28582__$1 = cljs.core.next(seq28582);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28583,seq28582__$1);
}));
...
var map__28615 = options;
var map__28615__$1 = cljs.core.__destructure_map(map__28615);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28615__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28615__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28615__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28615__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28616 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28616,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28616,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28616,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28616,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28616,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28616,(5),null);
...
var o__27792__auto__ = f;
return (o__27792__auto__["getBasis"]).call(o__27792__auto__);
});
/**
...
}catch (e28630){var _e__27845__auto__ = e28630;
...
var _STAR_ = (function (accum,p__28641){
var vec__28642 = p__28641;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28642,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28642,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28646){
...
var post_process = (function (p__28658){
var vec__28659 = p__28658;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28659,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28659,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28656_SHARP_){
return (obj[cljs.core.first(p1__28656_SHARP_)]);
}),sorted_matches);
