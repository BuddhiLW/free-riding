...
var o28024 = temp__5802__auto__;
var temp__5802__auto____$1 = (o28024["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o28025 = temp__5802__auto____$1;
return (o28025["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27747__auto__ = f;
return (o__27747__auto__["toString"]).call(o__27747__auto__);
} else {
return "";
}
}catch (e28043){var _ = e28043;
return "";
}});
...
try{var o__27747__auto___28616 = t;
(o__27747__auto___28616["cljs$lang$ctorPrWriter"]).call(o__27747__auto___28616,t,writer);
}catch (e28059){var __28617 = e28059;
}
...
var char_code = (function (){var o__27747__auto__ = (new String(char$));
return (o__27747__auto__["charCodeAt"]).call(o__27747__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27747__auto__ = String;
return (o__27747__auto__["fromCharCode"]).call(o__27747__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28096 = num_code;
switch (G__28096) {
case (1):
return (185);
...
var o__27747__auto__ = String;
return (o__27747__auto__["fromCharCode"]).call(o__27747__auto__,superscript_code);
});
/**
...
}catch (e28137){var _e__27790__auto__ = e28137;
return false;
}})())){
...
var vec__28140 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28140,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28190){
var vec__28191 = p__28190;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28191,(0),null);
...
var G__28642 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28643 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28642;
remaining_tokens = G__28643;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28178){
var G__28179 = cljs.core.first(seq28178);
var seq28178__$1 = cljs.core.next(seq28178);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28179,seq28178__$1);
}));
...
var vec__28220 = cljs.core.split_with((function (p1__28219_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28219_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28220,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28220,(1),null);
...
var vec__28234 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28234,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28234,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28646 = cljs.core.rest(remaining_tokens);
var G__28647 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28646;
name_tokens = G__28647;
continue;
} else {
...
var vec__28264 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28264,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28264,(1),null);
var vec__28267 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28267,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28267,(1),null);
var vec__28270 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28270,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28270,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28270,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28270,(3),null);
...
var vec__28301 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28301,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28301,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28301,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28301,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28301,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28301,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__28310 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28310,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28310,(1),null);
var vec__28313 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28313,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28313,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28328 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28328) : devtools.munging.parse_fn_info_deep.call(null,G__28328));
})()));
}
} else {
return fn_info;
...
var G__28674 = (arity + (1));
var G__28675 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28372){
var vec__28373 = p__28372;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28373,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28373,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28413_SHARP_){
...
var args__5775__auto__ = [];
var len__5769__auto___28682 = arguments.length;
var i__5770__auto___28683 = (0);
while(true){
if((i__5770__auto___28683 < len__5769__auto___28682)){
args__5775__auto__.push((arguments[i__5770__auto___28683]));

var G__28685 = (i__5770__auto___28683 + (1));
i__5770__auto___28683 = G__28685;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28429){
var vec__28430 = p__28429;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28430,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28425){
var G__28426 = cljs.core.first(seq28425);
var seq28425__$1 = cljs.core.next(seq28425);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28426,seq28425__$1);
}));
...
var map__28514 = options;
var map__28514__$1 = cljs.core.__destructure_map(map__28514);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28514__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28514__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28514__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28514__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28515 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28515,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28515,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28515,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28515,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28515,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28515,(5),null);
...
var o__27747__auto__ = f;
return (o__27747__auto__["getBasis"]).call(o__27747__auto__);
});
/**
...
}catch (e28527){var _e__27790__auto__ = e28527;
...
var G__28705 = (obj[cljs.core.first(path)]);
var G__28706 = cljs.core.rest(path);
obj = G__28705;
path = G__28706;
continue;
} else {
...
var _STAR_ = (function (accum,p__28553){
var vec__28554 = p__28553;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28554,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28554,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28562){
var vec__28563 = p__28562;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28563,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28563,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28563,(2),null);
...
var post_process = (function (p__28583){
var vec__28584 = p__28583;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28584,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28584,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28576_SHARP_){
return (obj[cljs.core.first(p1__28576_SHARP_)]);
}),sorted_matches);
