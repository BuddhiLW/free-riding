...
var G__47162 = request;
var G__47163 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__47162,G__47163) : ajax.formats.get_format.call(null,G__47162,G__47163));
} else {
...
return cljs.core.some((function (p1__47188_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__47188_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__47208){
var map__47209 = p__47208;
var map__47209__$1 = cljs.core.__destructure_map(map__47209);
var request = map__47209__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47209__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__47219 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__47219.cljs$core$IFn$_invoke$arity$1 ? fexpr__47219.cljs$core$IFn$_invoke$arity$1(response) : fexpr__47219.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__47222){
var map__47223 = p__47222;
var map__47223__$1 = cljs.core.__destructure_map(map__47223);
var request = map__47223__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47223__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__47220_SHARP_){
return ajax.formats.get_accept_entries(request,p1__47220_SHARP_);
