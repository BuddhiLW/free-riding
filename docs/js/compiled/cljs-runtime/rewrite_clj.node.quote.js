...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38087,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__38130 = k38087;
var G__38130__$1 = (((G__38130 instanceof cljs.core.Keyword))?G__38130.fqn:null);
switch (G__38130__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k38087,else__5346__auto__);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38086){
var self__ = this;
var G__38086__$1 = this;
return (new cljs.core.RecordIter((0),G__38086__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38088,other38089){
var self__ = this;
var this38088__$1 = this;
return (((!((other38089 == null)))) && ((((this38088__$1.constructor === other38089.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38088__$1.tag,other38089.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38088__$1.prefix,other38089.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38088__$1.sym,other38089.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38088__$1.children,other38089.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38088__$1.__extmap,other38089.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38087){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k38087);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38086){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38209 = cljs.core.keyword_identical_QMARK_;
var expr__38210 = k__5352__auto__;
if(cljs.core.truth_((pred__38209.cljs$core$IFn$_invoke$arity$2 ? pred__38209.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__38210) : pred__38209.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__38210)))){
return (new rewrite_clj.node.quote.QuoteNode(G__38086,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38209.cljs$core$IFn$_invoke$arity$2 ? pred__38209.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__38210) : pred__38209.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__38210)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__38086,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38209.cljs$core$IFn$_invoke$arity$2 ? pred__38209.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__38210) : pred__38209.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__38210)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__38086,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38209.cljs$core$IFn$_invoke$arity$2 ? pred__38209.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__38210) : pred__38209.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__38210)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__38086,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38086),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38086){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__38086,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__38102){
var extmap__5385__auto__ = (function (){var G__38244 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__38102,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__38102)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38244);
} else {
return G__38244;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__38102),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__38102),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__38102),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__38102),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__38320 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__38320;
continue;
}
break;
...
var G__38322 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__38322;
continue;
}
break;
...
var G__38323 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__38323;
continue;
}
break;
...
var G__38324 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__38324;
continue;
}
break;
