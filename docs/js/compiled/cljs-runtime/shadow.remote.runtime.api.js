...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_42723 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_42723(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_42724 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_42724(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_42729 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_42729(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_42731 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_42731(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_42733 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_42733(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_42735 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_42735(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__42718,callback){
var map__42719 = p__42718;
var map__42719__$1 = cljs.core.__destructure_map(map__42719);
var input = map__42719__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42719__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42719__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
