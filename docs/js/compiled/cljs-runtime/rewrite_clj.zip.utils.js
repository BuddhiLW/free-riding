...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__39055,k,f){
var vec__39063 = p__39055;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39063,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39063,(1),null);
var loc = vec__39063;
...
var G__39125 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__39125;
continue;
}
break;
...
var G__39127 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__39127;
continue;
} else {
return zloc__$1;
...
var G__39129 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__39129;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__39088){
...
var path = map__39092__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39092__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__39089;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__39097){
var vec__39098 = p__39097;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39098,(0),null);
var map__39101 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39098,(1),null);
var map__39101__$1 = cljs.core.__destructure_map(map__39101);
var path = map__39101__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39101__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__39098;
if(cljs.core.seq(r)){
...
var vec__39106 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39106,(0),null);
var map__39109 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39106,(1),null);
var map__39109__$1 = cljs.core.__destructure_map(map__39109);
var path = map__39109__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39109__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39109__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39109__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39109__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
