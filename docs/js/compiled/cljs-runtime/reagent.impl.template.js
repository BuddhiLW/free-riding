...
var G__35493 = o;
reagent.impl.template.goog$module$goog$object.set(G__35493,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__35573__delegate = function (args){
...
return G__35573__delegate.call(this,args);};
...
return G__35573__delegate(args);
});
...
var G__35510 = o;
reagent.impl.template.goog$module$goog$object.set(G__35510,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__35580__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__35581__i < G__35581__a.length) {G__35581__a[G__35581__i] = arguments[G__35581__i + 0]; ++G__35581__i;}
  args = new cljs.core.IndexedSeq(G__35581__a,0,null);
} 
return G__35580__delegate.call(this,args);};
...
return G__35580__delegate(args);
});
...
var G__35520 = props;
var G__35520__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35520,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35520);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35520__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__35527 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35527,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__35527;
}
})(),id_class);
...
var G__35535 = (cljs.core.count(argv) - first_child);
switch (G__35535) {
case (0):
...
var vec__35536 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35536,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35536,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35536,(2),null);
...
var temp__5808__auto___35591 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___35591 == null)){
} else {
var key_35592 = temp__5808__auto___35591;
(jsprops.key = key_35592);
}
...
var temp__5808__auto___35593 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___35593 == null)){
} else {
var key_35594 = temp__5808__auto___35593;
(jsprops.key = key_35594);
}
...
var temp__5808__auto___35595 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___35595 == null)){
} else {
var key_35596 = temp__5808__auto___35595;
(jsprops.key = key_35596);
}
...
var temp__5808__auto___35606 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___35606 == null)){
} else {
var key_35607 = temp__5808__auto___35606;
(jsprops.key = key_35607);
}
...
var temp__5808__auto___35609 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___35609 == null)){
} else {
var key_35610 = temp__5808__auto___35609;
(jsprops.key = key_35610);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35539_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__35539_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__35541 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35541,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35541,(1),null);
...
break;
default:
var G__35617 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__35618 = compiler;
v = G__35617;
compiler = G__35618;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template35555 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template35555 = (function (opts,id,fn_to_element,parse_fn,meta35556){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta35556 = meta35556;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template35555.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_35557,meta35556__$1){
var self__ = this;
var _35557__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template35555(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta35556__$1));
}));

(reagent.impl.template.t_reagent$impl$template35555.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_35557){
var self__ = this;
var _35557__$1 = this;
return self__.meta35556;
}));

(reagent.impl.template.t_reagent$impl$template35555.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template35555.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template35555.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template35555.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template35555.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template35555.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta35556","meta35556",-1366862125,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template35555.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template35555.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template35555");

(reagent.impl.template.t_reagent$impl$template35555.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template35555");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template35555.
 */
reagent.impl.template.__GT_t_reagent$impl$template35555 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template35555(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta35556){
return (new reagent.impl.template.t_reagent$impl$template35555(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta35556));
});

}

return (new reagent.impl.template.t_reagent$impl$template35555(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
