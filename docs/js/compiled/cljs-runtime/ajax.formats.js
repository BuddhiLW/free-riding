...
var G__46488 = request;
var G__46489 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__46488,G__46489) : ajax.formats.get_format.call(null,G__46488,G__46489));
} else {
...
return cljs.core.some((function (p1__46491_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__46491_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__46492){
var map__46493 = p__46492;
var map__46493__$1 = cljs.core.__destructure_map(map__46493);
var request = map__46493__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46493__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__46509 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__46509.cljs$core$IFn$_invoke$arity$1 ? fexpr__46509.cljs$core$IFn$_invoke$arity$1(response) : fexpr__46509.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__46514){
var map__46515 = p__46514;
var map__46515__$1 = cljs.core.__destructure_map(map__46515);
var request = map__46515__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46515__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__46511_SHARP_){
return ajax.formats.get_accept_entries(request,p1__46511_SHARP_);
