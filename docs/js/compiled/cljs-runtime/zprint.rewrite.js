...
var G__40210 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__40210;
continue;
} else {
var G__40211 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__40211;
continue;
}
} else {
var G__40212 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__40212;
continue;
}
}
...
var G__40135 = zloc;
var G__40136 = (function (){var G__40137 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__40138 = zloc;
var G__40138__$1 = (((G__40138 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__40138) : rewrite_clj.zip.node.call(null,G__40138)));
if((G__40138__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__40138__$1) : zprint.zutil.edn_STAR_.call(null,G__40138__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__40137) : rewrite_clj.zip.root.call(null,G__40137));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__40135,G__40136) : rewrite_clj.zip.replace.call(null,G__40135,G__40136));
});
/**
...
var G__40221 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__40221;
continue;
}
break;
...
var G__40226 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__40227 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__40226;
out = G__40227;
continue;
} else {
...
var G__40242 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__40243 = cljs.core.next(new_loc);
var G__40244 = replaced_loc;
nloc = G__40242;
new_loc = G__40243;
last_loc = G__40244;
continue;
...
return zprint.rewrite.sort_val((function (){var G__40173 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__40173) : rewrite_clj.zip.down.call(null,G__40173));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__40177_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__40177_SHARP_) : rewrite_clj.zip.tag.call(null,p1__40177_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__40177_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__40177_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
