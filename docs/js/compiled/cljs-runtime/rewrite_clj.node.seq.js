...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k38448,else__5346__auto__){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__38447){
var self__ = this;
var G__38447__$1 = this;
return (new cljs.core.RecordIter((0),G__38447__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this38449,other38450){
var self__ = this;
var this38449__$1 = this;
return (((!((other38450 == null)))) && ((((this38449__$1.constructor === other38450.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38449__$1.tag,other38450.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38449__$1.wrap_fn,other38450.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38449__$1.wrap_length,other38450.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38449__$1.seq_fn,other38450.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38449__$1.children,other38450.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this38449__$1.__extmap,other38450.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__38474 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__38474) : self__.seq_fn.call(null,G__38474));
}));
...
var self__ = this;
var this$__$1 = this;
var G__38475 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__38475) : self__.wrap_fn.call(null,G__38475));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k38448){
var self__ = this;
var this__5350__auto____$1 = this;
var G__38493 = k38448;
var G__38493__$1 = (((G__38493 instanceof cljs.core.Keyword))?G__38493.fqn:null);
switch (G__38493__$1) {
case "tag":
case "wrap-fn":
case "wrap-length":
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__38447){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__38495 = cljs.core.keyword_identical_QMARK_;
var expr__38496 = k__5352__auto__;
if(cljs.core.truth_((pred__38495.cljs$core$IFn$_invoke$arity$2 ? pred__38495.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__38496) : pred__38495.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__38496)))){
return (new rewrite_clj.node.seq.SeqNode(G__38447,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38495.cljs$core$IFn$_invoke$arity$2 ? pred__38495.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__38496) : pred__38495.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__38496)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__38447,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38495.cljs$core$IFn$_invoke$arity$2 ? pred__38495.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__38496) : pred__38495.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__38496)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__38447,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38495.cljs$core$IFn$_invoke$arity$2 ? pred__38495.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__38496) : pred__38495.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__38496)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__38447,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__38495.cljs$core$IFn$_invoke$arity$2 ? pred__38495.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__38496) : pred__38495.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__38496)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__38447,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__38447),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__38447){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__38447,self__.__extmap,self__.__hash));
}));
...
var extmap__5385__auto__ = (function (){var G__38511 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__38451,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__38451)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__38511);
} else {
return G__38511;
}
})();
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__38515_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__38515_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__38518_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__38518_SHARP_);
}),children);
});
