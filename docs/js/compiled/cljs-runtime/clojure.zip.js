...
var G__38917 = clojure.zip.node(loc);
var fexpr__38916 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38916.cljs$core$IFn$_invoke$arity$1 ? fexpr__38916.cljs$core$IFn$_invoke$arity$1(G__38917) : fexpr__38916.call(null,G__38917));
});
/**
...
var G__38919 = clojure.zip.node(loc);
var fexpr__38918 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38918.cljs$core$IFn$_invoke$arity$1 ? fexpr__38918.cljs$core$IFn$_invoke$arity$1(G__38919) : fexpr__38918.call(null,G__38919));
} else {
...
var fexpr__38920 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38920.cljs$core$IFn$_invoke$arity$2 ? fexpr__38920.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__38920.call(null,node,children));
});
/**
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38924,(1),null);
var vec__38927 = clojure.zip.children(loc);
...
var map__38939 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38936,(1),null);
var map__38939__$1 = cljs.core.__destructure_map(map__38939);
var path = map__38939__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38939__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38939__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38939__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38939__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38939__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__38945 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38945,(0),null);
var map__38948 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38945,(1),null);
var map__38948__$1 = cljs.core.__destructure_map(map__38948);
var path = map__38948__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38948__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__38949 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38948__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__38955 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38955,(0),null);
var map__38958 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38955,(1),null);
var map__38958__$1 = cljs.core.__destructure_map(map__38958);
var path = map__38958__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38958__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38958__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__38962 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38962,(0),null);
var map__38965 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38962,(1),null);
var map__38965__$1 = cljs.core.__destructure_map(map__38965);
var path = map__38965__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38965__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38965__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var map__38973 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38970,(1),null);
var map__38973__$1 = cljs.core.__destructure_map(map__38973);
var path = map__38973__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38973__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38973__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__38981 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38981,(0),null);
var map__38984 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38981,(1),null);
var map__38984__$1 = cljs.core.__destructure_map(map__38984);
var path = map__38984__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38984__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__38987 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38987,(0),null);
var map__38990 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38987,(1),null);
var map__38990__$1 = cljs.core.__destructure_map(map__38990);
var path = map__38990__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38990__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__38992 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38992,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38992,(1),null);
...
var len__5769__auto___39045 = arguments.length;
var i__5770__auto___39052 = (0);
while(true){
if((i__5770__auto___39052 < len__5769__auto___39045)){
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq38997){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38998,G__38999,seq38997__$2);
}));
...
var G__39068 = clojure.zip.rightmost(child);
loc__$1 = G__39068;
continue;
} else {
return loc__$1;
...
var vec__39009 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39009,(0),null);
var map__39012 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39009,(1),null);
var map__39012__$1 = cljs.core.__destructure_map(map__39012);
var path = map__39012__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39012__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39012__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39012__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39012__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__39070 = clojure.zip.rightmost(child);
loc__$1 = G__39070;
continue;
} else {
return loc__$1;
